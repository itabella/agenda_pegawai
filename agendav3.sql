...
--
-- Host: 127.0.0.1
-- Generation Time: 21 Sep 2016 pada 21.55
...
(30, 'Seminar', '2016-08-30 10:00:00', 'Seminar', '2016-08-29 15:26:02', 'cobacoba', 1, 1, 2);
...
INSERT INTO `agenda_peserta` (`id_agenda_peserta`, `nama_aktivitas`, `waktu_mulai`, `waktu_selesai`, `keterangan`, `tanggal_entry`, `update_by`, `id_agenda`, `id_unit`, `id_ruang`) VALUES
(12, 'Pelaksanaan Seminar', '2016-08-16 17:00:00', '2016-08-16 19:15:00', 'Belum terlaksana', '2016-09-17 20:26:30', 'cobacoba', 24, 2, 3),
(13, 'Rapat 1 Seminar internasional', '2016-08-20 13:25:00', '2016-08-20 17:25:00', 'Rapat', '2016-09-17 22:20:04', '11111', 25, 3, 1),
(14, 'Agenda Farmasi', '2016-08-26 18:00:00', '2016-08-26 20:00:00', 'Farmasi', '2016-08-25 18:46:09', 'cobacoba', 25, 1, 0),
(15, 'coba', '2016-08-19 15:50:00', '2016-08-20 15:00:00', 'tambah ruang D3 Teknik Informatika', '2016-08-26 08:08:27', 'cobacoba', 25, 2, 4);
...
(13, 'Eryka', 11111, 'Solo baru', '082225212441', 'anu oc new logo(1).png', 3, 1),
(14, 'Zainul', 123456789, 'Klaten', '085869220850', 'anu oc new logo(1).png', 2, 2),
(15, 'maghfira', 12345, 'Klaten', '085702062141', 'anu oc new logo(1).png', 1, 2),
...
(14, '11111', '', '$2y$13$9BLtxxqL1QaYQJvrNmibaerH6aHqMJIB4ssjmXTeud.0hrKgfslRq', NULL, 'itabe@ymail.com', 10, 0, 0, 13),
(15, '123456789', '', '$2y$13$yBgd6wrCwet3xml4PSFPpevo3fRuruFYLVINDzOu0WvDHVSyjrs3i', NULL, 'itabellakurniasari@ymail.com', 10, 0, 0, 14),
(16, '12345', '', '$2y$13$AXHSLqeVNz3EXp7aM0r6V./1yOtL2YndNkOsijnT0ohPRVoA.tlvK', NULL, 'mg@yahoo.co.id', 10, 0, 0, 15),
...
--
ALTER TABLE `agenda`
  MODIFY `id_agenda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
...
--
ALTER TABLE `detail_agenda_pegawai`
  MODIFY `id_detail_agenda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `detail_agenda_peserta`
--
ALTER TABLE `detail_agenda_peserta`
  MODIFY `id_detail_agenda_peserta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
